...
const StoreInfo = ({ title, children}) => {
    return (
        <>
        <ButtonBox>
        <Button width='72px' height='30px'>게시판</Button>
        <Spacer/>
        <Button width='120px' height='30px'>식당 상세 정보</Button>
        </ButtonBox>
        ...
        <div height='100px' style={{ display: 'flex', justifyContent: 'space-between'}}>
            <StoreInfoBox width='46%' height='130px' top='30px'>
                <div style={{ display: 'flex', flexDirection: 'column', marginLeft: '10px'}}>
                    <IconBox><Star/><InfoTextBox>4.25 / 5.0</InfoTextBox></IconBox>
                    <IconBox><LocationOnIcon/><InfoTextBox>대전시 유성구 궁동 000-00</InfoTextBox></IconBox>
                    <IconBox><PhoneIcon/><InfoTextBox>042-000-0000</InfoTextBox></IconBox>
                </div>
            </StoreInfoBox>
            <StoreInfoBox width='46%' height='160px'>지도</StoreInfoBox>  
        </div>

        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginLeft: '10px', marginTop: '20px', marginBottom: '20px'}}>
        <ReviewTextBox>Review</ReviewTextBox>
        <Button width='75px' height='30px'>리뷰 작성</Button>
        </div>
